         ...
         openExtension && <form className="flex flex-col w-full gap-4">
           ...
           <div className={`${styles.order_type}`}>
             ...
             <label>
               ...
               <p className="text-sm"> Polaroid Frame [Price - 400] [30 Posts] </p>
             </label>
             ...
             <label>
               ...
               <p className="text-sm"> Doodle Frame [Price - 600] [10 Posts] </p>
             </label>
             ...
             <label>
               ...
               <p className="text-sm"> Momento Book [Price - 500] [20 Posts] </p>
             </label>
           </div>
